...
gnuplot -e "datafile='queue_0.log'; 
            mytitle = 'Stats (pkt_size: 1024 B, arr_rate: 0.3125 pkts/s,sch_rate: 2 pkts/s)';
            outputname='stats_1024.jpg';
...
#            mytitle = 'Queue Stats (Packet size = 1024 Bytes, Arrival Rate = 0.3125 pkts/sec, Schedule Rate = 2 pkts/sec) [ES]';
#            outputname='qplot_1024.jpg';
#            x_label='time';
...
#            mytitle = 'Latency Stats (Packet size = 1024 Bytes, Arrival Rate = 0.3125 pkts/sec, Schedule Rate = 2 pkts/sec) [ES]';
#            outputname='lat_1024.jpg';
