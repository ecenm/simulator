...
gnuplot -e "datafile='queue_0.log'; 
            mytitle = 'Stats (pkt_size: 128 B, arr_rate: 2.5 pkts/s,sch_rate: 2 pkts/s)';
            outputname='stats_128.jpg';
...
#            mytitle = 'Queue Stats (Packet size = 128 Bytes, Arrival Rate = 2.5 pkts/sec, Schedule Rate = 2 pkts/sec) [ES]';
#            outputname='qplot_128.jpg';
#            x_label='time';
...
#
#gnuplot -e "datafile='output'; 
#            mytitle = 'Latency Stats (Packet size = 128 Bytes, Arrival Rate = 2.5 pkts/sec, Schedule Rate = 2 pkts/sec) [ES]';
#            outputname='lat_128.jpg';
#            x_label='Packet Number';
